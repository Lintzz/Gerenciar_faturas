...
class FrameAdicionarManager(FrameBase):
    ...
    def criar_frame_adicionar(self):
        ...
        self.frame_adiconar = ctk.CTkFrame(self.frame_borda_adicionar, width=300, height=300,fg_color="#252524",corner_radius=0)

        #titulo
        ctk.CTkLabel(self.frame_adiconar, text="Add Item", font=("Arial", 20, "bold")).grid(row=0, column=0, columnspan=2, pady=(10,10))

        # Data
        ctk.CTkLabel(self.frame_adiconar, text="Data",font=("Arial", 15)).grid(row=1, column=0, sticky="w", padx=(20,0), pady=7)
        ...
        # Nome
        ctk.CTkLabel(self.frame_adiconar, text="Nome",font=("Arial", 15)).grid(row=2, column=0, sticky="w", padx=(20,0), pady=7)
        ...
        self.nome.grid(row=2, column=1, sticky="we", padx=(0, 20))

        # Preço
        ctk.CTkLabel( self.frame_adiconar, text="Preço",font=("Arial", 15)).grid(row=3, column=0, sticky="w", padx=(20,0), pady=7)
        ...
        self.preco.grid(row=3, column=1, sticky="we",padx=(0, 20))

        # Categoria
        ctk.CTkLabel( self.frame_adiconar, text="Categoria",font=("Arial", 15)).grid(row=4, column=0, sticky="w", padx=(20,0), pady=7)
        ...
        self.categoria.grid(row=4, column=1, sticky="we", padx=(0, 20))
        self.categoria.set('Categorias')

        #botoes cancelar/salvar
        self.botoes_frame = ctk.CTkFrame( self.frame_adiconar, fg_color="transparent")
        self.botoes_frame.grid(row=5, column=0, columnspan=2, pady=(10,20))
...
class FrameEditarManager(FrameBase):
    def criar_frame_editar(self):
        ...
        self.frame_editar = ctk.CTkFrame(self.frame_borda_editar, width=300, height=300, fg_color="#252524", corner_radius=0)

        ctk.CTkLabel(self.frame_editar, text="Editar Item", font=("Arial", 20, "bold")).grid(row=0, column=0, columnspan=2, pady=(10,10))

        # Data
        ctk.CTkLabel(self.frame_editar, text="Data", font=("Arial", 15)).grid(row=1, column=0, sticky="w", padx=(20,0), pady=7)
        self.botao_dataa = ctk.CTkButton(
            self.frame_editar,
            text="Data",
            height=30,
            fg_color="#252524",
            ...
            text_color="white",
            hover_color="#444444",
            command=lambda: self.abrir_calendario(self.botao_dataa)
        )
        self.botao_dataa.grid(row=1, column=1, sticky="we", padx=(0, 20))

        # Nome
        ctk.CTkLabel(self.frame_editar, text="Nome", font=("Arial", 15)).grid(row=2, column=0, sticky="w", padx=(20, 0), pady=7)
        self.entry_nome = ctk.CTkEntry(self.frame_editar, height=30, fg_color="#252524", border_color="#3A3A3A", border_width=1, text_color="white")
        self.entry_nome.grid(row=2, column=1, sticky="we", padx=(0, 20))

        # Preço
        ctk.CTkLabel(self.frame_editar, text="Preço", font=("Arial", 15)).grid(row=3, column=0, sticky="w", padx=(20, 0), pady=7)
        self.entry_preco = ctk.CTkEntry(self.frame_editar, height=30, fg_color="#252524", border_color="#3A3A3A", border_width=1, text_color="white")
        self.entry_preco.grid(row=3, column=1, sticky="we", padx=(0, 20))

        # Categoria
        ctk.CTkLabel(self.frame_editar, text="Categoria", font=("Arial", 15)).grid(row=4, column=0, sticky="w", padx=(20, 0), pady=7)
        ...
        self.menu_categoria.grid(row=4, column=1, sticky="we", padx=(0, 20))

        # Botões
        botoes_frame_editar = ctk.CTkFrame(self.frame_editar, fg_color="transparent")
        botoes_frame_editar.grid(row=5, column=0, columnspan=2, pady=(10, 20))

        cancelar_btn_editar = ctk.CTkButton(
            botoes_frame_editar, width=120, height=30, font=("Arial", 14, "bold"),
            text="Cancelar", command=self.fechar_frame_editar,
            fg_color="#3A3A3A", hover_color="#444444",
    ...
    def abrir_frame_editar(self):
        ...
        self.item_id = itemSelecionado[0]
        valores = self.tv.item(self.item_id, 'values')
        ...
        for widget in self.winfo_children():
            if widget not in (self.canvas_blur, self.frame_editar):
                widget.lower()
        ...
        self.botao_dataa.configure(text=f"{self.data_selecionada}")
        ...
        self.menu_categoria.set(categoria_atual)
...
class Utilitarios:
    ...
    def abrir_calendario(self, botao):
        ...
        def confirmar_data():
            ...
            self.data_selecionada = data_formatada.strftime("%d %b").upper()
            ...
            for mes_en, mes_pt in meses_abreviados.items():
                self.data_selecionada = self.data_selecionada.replace(mes_en, mes_pt)

            botao.configure(text=f"{self.data_selecionada}")
            top.destroy()
    ...
    def grafico1(self):
        ...
        try:
            ...
            for categoria, valor in registros:
                dados[categoria] = dados.get(categoria, 0) + valor
        except Exception as e:
        ...
        if dados:
            labels_ordenados, valores_ordenados = zip(*sorted(dados.items(), key=lambda item: item[1], reverse=True))
        else:
        ...
        fig.text(0.8, 0.8, f"Total: R$ {sum(valores_ordenados):.2f}", ha='center', fontsize=11, color='white', fontweight='bold')
...
if __name__ == "__main__":
    app = App(icon_path)
    app.protocol("WM_DELETE_WINDOW", app.fechar_tudo)
    app.mainloop()